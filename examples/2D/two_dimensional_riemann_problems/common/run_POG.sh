...
./POG -m ./input/2DRP.g01.b001.geo -s ./input/2DRP.g01.b001-N_$n.sol -o output/2DRP.g01.b001 $tout #-cell # post-processing block 1
./POG -m ./input/2DRP.g01.b002.geo -s ./input/2DRP.g01.b002-N_$n.sol -o output/2DRP.g01.b002 $tout #-cell # post-processing block 2
./POG -m ./input/2DRP.g01.b003.geo -s ./input/2DRP.g01.b003-N_$n.sol -o output/2DRP.g01.b003 $tout #-cell # post-processing block 2
./POG -m ./input/2DRP.g01.b004.geo -s ./input/2DRP.g01.b004-N_$n.sol -o output/2DRP.g01.b004 $tout #-cell # post-processing block 4
exit 0
