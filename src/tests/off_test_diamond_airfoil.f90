!< OFF test: Mach 2 diamond airfoil.

program off_test_diamond_airfoil
!< OFF test: Mach 2 diamond airfoil.
...
contains
  ...
  call cli%init(progname='off_test_diamond_airfoil',   &
                authors='S. Zaghi',                    &
                help='Usage: ',                        &
                examples=["off_test_diamond_airfoil"], &
                epilog=new_line('a')//"all done")

  call cli%add(switch='--input',                                  &
               help='input file name',                            &
               required=.false.,                                  &
               def='src/tests/diamond_airfoil_input/diamond.ini', &
               act='store')
...
endprogram off_test_diamond_airfoil
