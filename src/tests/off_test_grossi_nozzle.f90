!< OFF test: Grossi nozzle.

program off_test_grossi_nozzle
!< OFF test: Grossi nozzle.
...
contains
  ...
  call cli%init(progname='off_grossi_nozzle',   &
                authors='S. Zaghi',             &
                help='Usage: ',                 &
                examples=["off_grossi_nozzle"], &
                epilog=new_line('a')//"all done")

  call cli%add(switch='--input',                         &
               help='input file name',                   &
               required=.false.,                         &
               def='src/tests/grossi-nozzle/nozzle.ini', &
               act='store')
...
endprogram off_test_grossi_nozzle
